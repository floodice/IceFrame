...
class ActionMenuPresenter extends BaseMenuPresenter
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!mMaxItemsSet) {
            mMaxItems = mContext.getResources().getInteger(
                    android.support.v7.appcompat.R.integer.abc_max_action_buttons);
        }
        if (mMenu != null) {
    ...
    public boolean flagActionItems() {
        ...
        final int querySpec = View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED);
        final ViewGroup parent = (ViewGroup) mMenuView;
    ...
    private class OverflowPopup extends MenuPopupHelper {
        ...
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView,
            ...
            super(context, menu, anchorView, overflowOnly, android.support.v7.appcompat.R.attr.actionOverflowMenuStyle);
